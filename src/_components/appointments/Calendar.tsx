  ...
  return (
    ...
    >
      <Select
        ...
        className="h-9 w-3/4 rounded-lg bg-ultralightGray pl-3 pr-0 text-sm font-bold text-green ring-0 lg:h-10"
        onChange={(e) => onMonthClick(e.target.value)}
      />

      <Select
        options={years}
        className="-ml-5 h-9 w-7/12 rounded-lg bg-ultralightGray pl-2 pr-0 text-sm font-bold text-green ring-0 lg:h-10"
...
> = ({
  ...
  <DayPicker
    ...
    classNames={{
      ...
      head_row:
        "flex border-b-[0.5px] border-b-lightGray pb-2 lg:border-none justify-between",
      head_cell:
        "lg:text-gray40 text-black font-semibold capitalize w-12 md:w-16 lg:w-16 xl:w-24 2xl:w-28 lg:font-bold",
